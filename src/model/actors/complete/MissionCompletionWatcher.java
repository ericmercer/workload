...
public MissionCompletionWatcher(ComChannelList inputs, ComChannelList outputs) {
	...
	initializeINFORM_MM(inputs, outputs, WAITING_FOR_LAUNCH, INFORM_MM, INFORM_MM);
	initializeENDING_SEQUENCE(inputs, outputs, ENDING_SEQUENCE, ENDING_SEQUENCE_1);
	initializeWAITING_FOR_LAUNCH(inputs, outputs, WAITING_FOR_LAUNCH, WAITING_FOR_LAUNCH);
 ...
 public void initializeINFORM_MM(ComChannelList inputs, ComChannelList outputs, State WAITING_FOR_LAUNCH, State INFORM_MM, State INFORM_MM) {
 ...
 public void initializeWAITING_FOR_LAUNCH(ComChannelList inputs, ComChannelList outputs, State WAITING_FOR_LAUNCH, State WAITING_FOR_LAUNCH) {
