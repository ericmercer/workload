...
public class WorkloadBuilder {
	...
	public static String build( WorkloadPath path ) {
		...
		String result = "time, resource data (Actor State [ActiveInput])*, resource workload, decision data (Actor State [NumberOfEnabledTransitions])*, decision workload, decision data (Actor State [TransitionDuration])*, decision workload, TaskStarts, TaskStops";
